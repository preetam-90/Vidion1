...
export default function GamingPage() {
  ...
  // Function to fetch gaming videos
  const fetchGamingVideos = useCallback(async (pageToken?: string) => {
    try {
      const response = await fetch(`/api/youtube/trending?region=${regionCode}&videoCategoryId=20${pageToken ? `&pageToken=${pageToken}` : ''}`)
  ...
  return (
    <div className="container mx-auto px-0 sm:px-4 py-4 sm:py-8">
      ...
      <InfiniteVideoGrid fetchVideos={fetchGamingVideos} batchSize={12} />
